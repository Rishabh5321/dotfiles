...
, ...
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/20ac0b3f-b435-4720-9bf9-f0e41b090d02";
    fsType = "btrfs";
    options = [ "subvol=@" ];
  };

  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/3A64-B2F3";
    fsType = "vfat";
  ...
  swapDevices = [
    {
      device = "/dev/disk/by-uuid/789b11a1-88d1-4fb4-ae04-217246f3916c";
    }
  ];
